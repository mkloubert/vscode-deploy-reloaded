        ...
        await ME.invokeForClient(context.target, async (client, t) => {
            ...
            for (const C of CHANNELS) {
                ...
                if (1 === FILES_TO_UPLOAD.length) {
                    ...
                    let workspaceName = deploy_helpers.normalizeString(t.__workspace.name);
                    ...
                    const ZIPPED_DATA = new Buffer(ZIPFile.generate({
                        base64: false,
                        comment: `Generated by 'Deploy Reloaded' (vscode-deploy-reloaded) Visual Studio Code extension:
