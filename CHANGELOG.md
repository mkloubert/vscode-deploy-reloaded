...
* added `saveBeforeDeploy` [setting](https://github.com/mkloubert/vscode-deploy-reloaded/wiki#settings--), which indicates to save documents in non saved editors, before they are going to be deploy ... this value is `(true)` by default ... s. [issue #143](https://github.com/mkloubert/vs-deploy/issues/143) of [vs-deploy](https://github.com/mkloubert/vs-deploy)
